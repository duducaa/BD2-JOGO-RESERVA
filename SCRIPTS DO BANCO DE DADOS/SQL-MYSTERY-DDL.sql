...
#TABLESPACE PARA AS TABELAS RELACIONADAS A PONTUACAO
DROP TABLESPACE PONTUACAO_TS;
CREATE TABLESPACE PONTUACAO_TS ADD DATAFILE 'pontuacao.ibd' ENGINE = InnoDB;
...
CREATE TABLE TB_MISTERIO (
	ID_MISTERIO INT UNSIGNED PRIMARY KEY AUTO_INCREMENT,
    TITULO_MISTERIO VARCHAR (255)
) TABLESPACE PONTUACAO_TS;

CREATE TABLE TB_PONTUACAO (
	ID_PONTUACAO INT UNSIGNED PRIMARY KEY AUTO_INCREMENT,
